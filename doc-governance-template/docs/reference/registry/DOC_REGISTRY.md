...
- **By `doc_class`**: `active`=26, `entrypoint`=2, `generated`=1
- **By `authority_kind`**: `blueprint`=3, `current_config`=5, `guide`=16, `plan`=3
...
| CHECK_NEEDS_ATTENTION | scripts/check_needs_attention.py | active | current_config | check_needs_attention.py — CI Escalation Gate | agents | active | — |
